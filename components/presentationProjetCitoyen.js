...
export default function PresentationProjetCitoyen() {
  return (
    <div className="h-screen snap-center flex flex-col">
      <div className="flex px-20 pt-20 h-1/2">
        <div>
      ...
      <div className="flex px-20 pt-10 h-1/2">
        <div>
          <h2 className="text-7xl font-bold text-indigo-600">Emmaus</h2>
          <p className="text-lg leading-relaxed m-4 text-gray-600">
            bla bla bla <Emphasis>super asso</Emphasis> bla bla bla du coup{" "}
            <Emphasis>créee par labbé Pierre </Emphasis> bla bla bla bla bla bla
            blabla blabla blabla blabla blabla blabla blabla blabla blabla
            blabla blabla blabla blabla bla{" "}
            <Emphasis>contre la pauvreté et lexclusion</Emphasis>
          </p>
        </div>
      </div>
    </div>
